...
\begin{table}\centering\footnotesize\sffamily
  \resizebox{\textwidth}{!}{%
    ...
    \begin{tabular}{l c c c c c}
      ...
      Policy coverage                 & 33 (100$\%$) & 14 (93$\%$) & 40 (71$\%$) & 10 (100\%)\tablefootnote{The Edindiburgh policy contains a large number of rules that whilst marked as such are infact just descriptions of the document.  All the policy rules that described restrictions or relationships were implemented in \AppPAL{}.} & 22 (88$\%$) \\
      \midrule
